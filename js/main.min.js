let userMenuToggle=document.querySelectorAll(".burger"),body=document.querySelector("body"),header=document.querySelector(".header");userMenuToggle&&userMenuToggle.forEach(e=>{e.onclick=function(){header.classList.toggle("_open"),body.classList.toggle("fixed-body")}});
